...
//                                                                                  .sizeOfEdgeCreationOrder(graph.getCreatedEdgesBySubSequenceIndex().size())
...
//        assertThat(sink.getGraph().getCreatedEdgesBySubSequenceIndex()).isEqualTo(graph.getCreatedEdgesBySubSequenceIndex());
//    }
//}
